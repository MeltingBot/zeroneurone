    ...
    <div className="divide-y divide-border-default">
      ...
      >
        <div className="space-y-4">
          ...
          {/* Creator */}
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-text-secondary">Créateur</label>
            <input
              type="text"
              value={creator}
              onChange={(e) => {
      ...
      >
        <div className="space-y-4">
          {/* Start Date */}
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-text-secondary">Date de début</label>
            <input
              type="date"
              value={startDate}
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-text-secondary">Créée le</label>
            <p className="text-sm text-text-primary">
              {formatDateDisplay(investigation.createdAt)}
            </p>
          </div>

          {/* Updated At (read-only) */}
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-text-secondary">Modifiée le</label>
            <p className="text-sm text-text-primary">
              {formatDateDisplay(investigation.updatedAt)}
            </p>
          </div>
        </div>
      </AccordionSection>
