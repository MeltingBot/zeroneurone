...
/**
 * Create a built-in TagSet with generated ID and timestamps
 */
function createBuiltInTagSet(
  data: Omit<TagSet, 'id' | 'isBuiltIn' | 'createdAt' | 'updatedAt'>
): TagSet {
  return {
    ...data,
    id: generateUUID(),
 ...
 * These are loaded on first app launch or when user resets to defaults
 */
export const DEFAULT_TAG_SETS: TagSet[] = [
  // ============================================================================
  // ENTITÉS DE BASE
  // ============================================================================
  ...
  createBuiltInTagSet({
    ...
    suggestedProperties: [
      ...
      { key: 'Nationalité', type: 'country', description: '', placeholder: 'France' },
  ...
  createBuiltInTagSet({
    ...
    suggestedProperties: [
      ...
      { key: 'Pays émetteur', type: 'country', description: '', placeholder: 'France' },
  ...
  createBuiltInTagSet({
    ...
    suggestedProperties: [
      ...
      { key: 'Pays', type: 'country', description: '', placeholder: 'France' },
  ...
  // ============================================================================
  // TAGS COMPLÉMENTAIRES (se combinent avec d'autres)
  // ============================================================================
